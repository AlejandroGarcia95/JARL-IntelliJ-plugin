...
import org.antlr.jetbrains.jarl.psi.IdentifierPSINode;
 ...
 *  to override.
 */
public class JarlASTFactory extends CoreASTFactory {
	...
	public LeafElement createLeaf(@NotNull IElementType type, CharSequence text) {
		if ( type instanceof TokenIElementType &&
			 ((TokenIElementType) type).getANTLRTokenType()==JarlLexer.RULE)
		{
