...
import org.antlr.jetbrains.jarl.JarlParserDefinition;
import org.jetbrains.annotations.NonNls;
import org.jetbrains.annotations.NotNull;

import static org.antlr.jetbrains.jarl.parser.JarlParser.*;
...
public class IdentifierPSINode extends ANTLRPsiLeafNode implements PsiNamedElement {
	...
	public PsiElement setName(@NonNls @NotNull String name) throws IncorrectOperationException {
		...
		PsiElement newID = Trees.createLeafFromText(getProject(), JarlLanguage.INSTANCE, getContext(), name, JarlParserDefinition.ID);
		if ( newID!=null ) {
